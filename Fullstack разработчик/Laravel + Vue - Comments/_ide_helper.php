...
')
     ...
     */ 
         ...
         * @return \Ionium\Captcha\Services\CaptchaService - после этого метода можно вызвать метод вывода captcha (getCaptcha)
         * @static 
         */ 
        public static function config($stringLength = 10, $permittedChars = '01')
        {
                        /** @var \Ionium\Captcha\Services\CaptchaService $instance */
                        return $instance->config($stringLength, $permittedChars);
        }
                    /**
...
namespace  { 
            ...
            class Captcha extends \Ionium\Captcha\Facades\Captcha {}
